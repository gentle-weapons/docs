...
jnc is a single executable with no external dependencies. Download the `aarch64` archive from the [GitHub releases](https://github.com/prefix-dev/pixi/releases), unpack it, and add it to your `PATH`.
...
```fish
jnc completion --shell fish | source
```
